...
public abstract class TLSVerticle extends AbstractVerticle {

  private static final Logger logger = Logger.getLogger(TLSVerticle.class);
  ...
  protected TLSVerticle() {
    ...
    setServerOptions(httpServerOptions);
